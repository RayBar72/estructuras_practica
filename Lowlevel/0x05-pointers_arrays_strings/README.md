...
0x05. C - Pointers, arrays and strings
    ...
    By Julien Barbier
    Weight: 1
    Project over - took place from Oct 12, 2021
    to Oct 13, 2021
    - you're done with 150% of tasks.
    An auto review will be launched at the deadline
    In a nutshell…
        Auto QA review: 71.0/71 mandatory & 12.35/24 optional
        Altogether:  151.46%
            Mandatory: 100.0%
            Optional: 51.46%
            Calculation:  100.0% + (100.0% * 51.46%)  == 151.46%
